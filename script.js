...
class Duck {
  constructor(x, y, count, speed) {
    ...
    this.spriteWidth = duckWidth;
    this.spriteHeight = duckHeight;
  ...
  updatedeads(){
    console.log(this.frameCounter,this.frameIndex);
    this.drawdead();
    this.y += this.speed;
    this.frameCounter++;
  ...
  drawdead() {
    let spriteSheetX = this.spriteWidth*6+this.frameIndex * this.spriteWidth;
      context.drawImage(
      this.spriteSheet,
      spriteSheetX,
      this.spriteSheetY,
